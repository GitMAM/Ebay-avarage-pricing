...
extension UIColor {
    ...
    static let statusBarColor = UIColor.black
    static let navBarColor = UIColor.rgb(r:33,g:33,b:33)
    static let backGroundColor = UIColor.rgb(r: 48, g: 48, b: 48)
    static let cellColor = UIColor.rgb(r: 60, g: 60, b: 60)
